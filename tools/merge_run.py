...
def main():
    ...
    hist = {
        ...
        "willhaben": "abgedeckt (Chrome, __NEXT_DATA__, Kärnten & Steiermark, Häuser & Grundstücke nach Aktualität). Volltreffer-Häuser: St. Georgen a.d. Stiefing/Südsteiermark (2.983 m², 160 m², 490k, Score 30) + Schwanberg/Weststeiermark (1.542 m², 230 m², 498k, Score 23). Volltreffer-Grundstücke: St. Andrä/Lavanttal (Bauland-Dorfgebiet, 1.191 m², fantastischer Ausblick, 60k, Score 43) + Gorintschach/Villach-Land (Bauland-Dorfgebiet, Fernblick, 1.477 m², 135k, 33) + Altenmarkt b. Riegersburg (Bauland, Riegersburgblick, 1.555 m², 40k, 33) + Reichenfels 67,9k, Ludmannsdorf 128k, Pernegg a.d. Mur 128k (alle Bauland belegt). Near-Miss: Bauernhof Feldkirchen 3,75 ha Alleinlage 750k (= Dublette zur Region Kärnten) + Anwesen St. Margareten im Rosental 698k; Grundstücke St. Peter-Freienstein (Widmung ungesichert) + St. Marein b. Graz 10.169 m²/189k (Widmung ungesichert).",
        "sub_agenten": "6 Großregionen parallel (Kärnten+Osttirol 11, Salzburg 8, Steiermark 13, Tirol+Vorarlberg 3, OÖ+NÖ 12, Südtirol 5 Kandidaten). Volltreffer-Häuser: Krakaudorf, Zeltweg, Ehrenhausen, Schwanberg/Gressenberg, Stainz (Steiermark) + Kaumberg, Gresten (NÖ) + Ulten/St. Walburg (Südtirol, 9.900 m²). Kärntner Bauernhöfe (Feldkirchen, Lavamünd, Radenthein, Birnbaum, Wolfsberg, Ferlach) 695–890k = Near-Miss Preis. Salzburg 0 Volltreffer (Innergebirge zu teuer bzw. Grund <1.000), Tirol+Vorarlberg 0 Volltreffer (Grund durchweg <1.000). Südtirol Baugrundstücke 0 (Ansässigkeit/Grünland); idealista/casa.it bot-blockiert, immomarkt-suedtirol.bz/pareggerpartner JS-gerendert.",
