...
def main():
    ...
    hist = {
        ...
        "willhaben": "abgedeckt (Chrome, __NEXT_DATA__, Kärnten & Steiermark, Häuser & Grundstücke nach Aktualität; 33 Kandidaten, 9 Volltreffer). Volltreffer-Häuser: Metnitz/Kärnten (285k, 300 m², 2.014 m², Bj. 1886) + Straden/Südoststeiermark (179k, 342 m², 4.072 m², sanierungsbed.) + Landhaus Hüttenberg (495k, 180 m², 1.327 m², Aussichtslage, Score 47). Volltreffer-Grundstücke: St. Salvator 125k/2.191 (Bauland-Dorfgebiet), St. Stefan im Gailtal/Hadersdorf 75k/1.006 (Aussicht), Kreuth-Pischeldorf 100k/1.380, Sittersdorf 79k/1.086, Framrach/St. Andräer See 53k/1.274 (alle Bauland), Rosental a.d. Kainach 65k/1.137 (Steiermark). Near-Miss: Architektenhaus Oberdörfl 895k, St. Oswald/Bad Kleinkirchheim 850k (Freizeitwohnsitz), Andritz 799k (Stadtrand), Leutschach 8-ha-Alleinlage 690k, Neudau 649k (Grund 954); Grundstücke Velden/Sonnental 195k, Rabnitz 155k, Pölfing-Brunn 165k, Ludmannsdorf 98k (Widmung/Preis).",
        "sub_agenten": "6 Großregionen parallel (Kärnten+Osttirol 10, Salzburg 5, Steiermark 12, Tirol+Vorarlberg 3, OÖ+NÖ 14, Südtirol 6 Kandidaten). Volltreffer u.a.: Kärnten Landhaus Fischertratten/Malta (455k, 180 m², 2.416 m², Score 60) + Knappenberg/Hüttenberg (475k, 224 m²) + Baugründe Kötschach-Mauthen (110k/1.090) & Eberndorf (Near-Miss Preis); Steiermark EFH Krakaudorf/Murau (545k, 258 m², 2.659 m², Score 55) + Gnas (280k, 198 m²) + Unterlamm (650k, 243 m²) + Baugründe Krakau (146k/3.246, Score 60), St. Lambrecht, Straden, Oberpurkla; OÖ+NÖ Bauernhaus Maria Laach/Jauerling (198k, 184 m²) + EFH Gresten (280k, 188 m²) + Baugründe Vorderstoder, Gresten, Perwarth/Randegg; Salzburg Bauernhaus Hopfberg/Taxenbach (570k, 200 m², 1.475 m², Score 62); Südtirol EFH Mühlwald/Selva dei Molini (540k, 312 m², 1.550 m²). Tirol+Vorarlberg 0 Volltreffer (Grund durchweg <1.000). Südtirol 0 gesicherte Baugrundstücke; idealista/casa.it bot-blockiert, immomarkt-suedtirol.bz/pareggerpartner JS-gerendert.",
