...
- Öffne für JEDEN Kandidaten die Einzel-Exposéseite und bestätige: Kaufpreis, Wohnfläche, Grundfläche, Nutzfläche, Objekttyp, Widmung (Hauptwohnsitz vs. Freizeit), Zustand/Baujahr/Sanierung, Bergblick/Hanglage, Alleinlage/Nachbarn. Erfasse dabei die **Vorschaubild-URL** (Meta-Tag `og:image` der Exposéseite) als Feld `bild` (nur die URL speichern, kein Download).
