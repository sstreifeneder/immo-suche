...
NOW_ISO = "2026-07-22T16:27:00+02:00"
TODAY = "2026-07-22"
...
def main():
    ...
    hist = {
        ...
        "willhaben": "abgedeckt (Chrome, __NEXT_DATA__, Kärnten & Steiermark, Häuser ≤900k & Grundstücke ≤200k nach Aktualität). Geblättert bis Inseratsdatum 21.07.: Kärnten Häuser 7 Seiten, Steiermark Häuser 12 Seiten, Kärnten Grundstücke 3 Seiten, Steiermark Grundstücke 6 Seiten = 840 Anzeigen. Nach WF≥160- bzw. Grund>1.000-Filter, Typ-Whitelist und Dedup gegen 437 bekannte willhaben-IDs 167 Kandidaten; nach Inhalts-Fingerprint-Dedup 120 zur Exposé-Prüfung (PLOT/AREA für die echte Grundstücksgröße, DESCRIPTION für Widmung/Typ). Übernommen: 75 (36 Häuser + 39 Grundstücke), davon 46 Volltreffer. Aussortiert: Häuser mit Grund <1.000 m² (Exposé-PLOT/AREA, u.a. Klagenfurt/Velden/Spittal/Graz-Stadt), zwei-/mehrfamilien laut Detailtext (Rosegg, Villach-Lind, Straden, Eggersdorf, Oberort, Rohrbach), Freizeit-/Freiland-/Almwidmung (Bodental, St. Peter am Kammersberg, Klippitztörl); Grundstücke mit Aufschließungsgebiet (Södingberg A-WR), Freizeitwohnsitz-Sonderwidmung (Ludmannsdorf) bzw. Bauland-Anteil <1.000 m² (Leibnitz). Häuser 650–900k und Grundstücke 150–200k als TEIL Preis geführt.",
        "sub_agenten": "6 Großregionen parallel (Kärnten+Osttirol 17, Salzburg 5, Steiermark 20, Tirol+Vorarlberg 7, OÖ+NÖ 11, Südtirol 4 = 64 Kandidaten, 22 Volltreffer nach Normalisierung). Volltreffer u.a.: Kärnten EFH Reisach/Gailtal 495k/308/1.909 + Hermagor 410k/240/1.495 + Mühlbach/St. Jakob 590k/176/1.682 + Baugründe Ludmannsdorf 99,5k/1.064 (Bauland-Wohngebiet) & St. Stefan im Gailtal 75,45k/1.006; Steiermark EFH/Landhäuser Krakaudorf 545k/258/2.659, Fohnsdorf 175k/200/1.064, Jauring/Aflenz Holzhaus 550k/228/1.002, Weißenbach a.d. Enns 299k/200/2.473 + Baugründe Fohnsdorf 112k/1.120, Pöls 110k/1.410, St. Margarethen 79,5k/1.023, Kirchbach 75k/1.202; OÖ+NÖ Bauernhaus Schalchen 399k/200/24.654 + EFH Gresten 280k/188/1.089 + Baugründe Sitzendorf 40,8k/1.046 & St. Leonhard am Forst 84k/2.283; Salzburg Bauernhaus Hopfberg/Taxenbach (Bieterverfahren 570k, 200/1.475, eigene Quelle, Score 77). Strukturbefunde: Tirol+Vorarlberg 0 Volltreffer (Grund durchweg <1.000 m², Bauland >200k, mehrfach Freizeitwohnsitz); Südtirol 0 Volltreffer (Konventionierung/geschlossener Hof, kleinparzelliertes Bauland); Salzburg kein gewidmetes Bauland >1.000 m² unter 200.000 € am Markt. Blockiert/eingeschränkt: mehrere Exposés HTTP 410/404 (abgelaufen) verworfen; remax.at robots-gesperrt; immo.sn.at/immmo.at teils leere Hüllen; keine maschinenlesbaren Inseratsdaten -> Reihung nach Kriterien statt strikt nach Datum.",
