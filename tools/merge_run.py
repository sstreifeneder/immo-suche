...
NOW_ISO = "2026-08-05T09:52:00+02:00"
TODAY = "2026-08-05"
...
def main():
    ...
    hist = {
        ...
        "willhaben": "abgedeckt (Chrome, __NEXT_DATA__, Kärnten & Steiermark, Häuser ≤900k & Grundstücke ≤200k nach Aktualität). Delta ~2 Tage seit letztem Lauf (03.08. 09:40) → geblättert bis Cutoff 03.08.: Kärnten Häuser 3 Seiten (rows=90), Steiermark Häuser 5, Kärnten Grundstücke 1, Steiermark Grundstücke 2 = 990 Anzeigen gescannt. Nach ID-Dedup gegen 742 bekannte willhaben-IDs und WF≥160- bzw. Grund>1.000-Filter 82 neue Kandidaten Exposé-geprüft (PLOT/AREA für echte Grundfläche, DESCRIPTION für Widmung/Typ) plus 72 vorab per Titel gefiltert. Übernommen: 41 (28 Häuser + 13 Grundstücke), davon 19 Volltreffer. Aussortiert: 46 Exposé-Drops (Häuser Grund<1.000 bzw. ohne PLOT/AREA, Grundstücke ohne belegte Bauland-Widmung) + 72 Titel-Vorfilter (Freizeit/Gewerbe/Ausschluss-Typen); zusätzlich 6 per PROPERTY_TYPE-/Titel-Sicherheitsnetz auf TEIL Typ herabgestuft (Mehrfamilienhaus/Bungalow, Titel „vier Einheiten\"/„2 Wohnhäuser\"/Tankstelle). Häuser 650–900k und Grundstücke 150–200k als TEIL Preis geführt.",
        "sub_agenten": "6 Großregionen parallel (Kärnten+Osttirol 11, Salzburg 6, Steiermark 23, Tirol+Vorarlberg 8, OÖ+NÖ 17, Südtirol 5 = 70 Kandidaten, 29 Volltreffer nach Normalisierung). Volltreffer u.a.: Steiermark 16 (Stubenberg am See Selbstversorgerhof 640k/240/55.000 Score 88, Stainz Landhaus 650k/190/13.000 Score 80, Krakaudorf EFH 545k/258/2.659, Baugründe Plesch-St. Anna 115k/3.276 & Mureck 69k); OÖ+NÖ 8 (Ramsau b. Hainfeld EFH 490k/280/1.918 Score 67, Schalchen Bauernhaus 399k/200/24.654, Baugründe Herzogsdorf 68k/1.021 & Perwarth 56,5k/1.002); Kärnten+Osttirol 3 (Diex Landhaus 548k/280/4.163 Score 69, Reisach EFH 495k/308/1.909, Baugrund Hadersdorf 75,45k/1.006); Salzburg 1 (Bauernhaus Taxenbach Bieterverfahren 570k/200/1.475 Score 55); Tirol+Vorarlberg 1 (Ainet Landhaus 499k/218/1.229). Strukturbefunde: Tirol+Vorarlberg Häuser fast durchweg Grund <1.000 m² bzw. >650k, Bauland >200k, mehrfach Freizeitwohnsitz; Südtirol 0 Volltreffer (Grundfläche selten beziffert, Bauland kleinparzelliert/Agrar, Konventionierung); Salzburg kein gewidmetes Bauland >1.000 m² unter 200.000 € am Markt. Blockiert/eingeschränkt: remax.at robots-gesperrt; idealista/immo.sn.at teils leere Hüllen bzw. robots-gesperrt; mehrere Exposés HTTP 410/404 (abgelaufen) verworfen.",
