...
kopf = (f"# Delta-Bericht Immobilien-Lauf\n\n"
        ...
        f"Suche: 6 Großregionen parallel über Sub-Agenten (Kärnten+Osttirol 21, Salzburg 16, Steiermark 12, Tirol+Vorarlberg 14, OÖ+NÖ 14, Südtirol 7 = 84 Kandidaten) + **willhaben via Chrome-Browser** (Kärnten & Steiermark, Häuser & Grundstücke nach Aktualität bis 16.07.: Kärnten Häuser 11 Seiten/326, Steiermark Häuser 15 Seiten/447 ≤650k, Kärnten Grundstücke 102, Steiermark Grundstücke 248 → nach Filter 86 Kandidaten). Bei willhaben-Häusern wurde die Grundstücksgröße einzeln aus dem Exposé-Detail (`PLOT/AREA`) verifiziert, bei Grundstücken die Widmung aus dem Exposé-Text (`DESCRIPTION`) belegt; Objekte ohne belegte Bauland-Widmung, mit Grund <1.000 m² oder mit ausgeschlossenem Typ (Doppel-/Reihen-/Mehrfamilienhaus, Freizeitwohnsitz) sind nicht als Volltreffer geführt.\n\n"
        f"Häuser 650–900k und Grundstücke 150–200k sind als Near-Miss „TEIL – verfehlt: Preis\" geführt (Zielpreise 650k bzw. 150k). ⚠️ Tirol+Vorarlberg 0 Volltreffer (Grund durchweg <1.000 m², Bauland >1.000 m² durchweg >200k; teils Freizeitwohnsitz/Preis auf Anfrage); ⚠️ Südtirol 0 Volltreffer (Konventionierung/geschlossener Hof; Bauland >1.000 m² unter 200k praktisch nicht am Markt). Blockiert/Hochpreis: pareggerpartner.com, engelvoelkers.com; idealista/immobilienscout24 JS-lastig. "
        f"Dubletten zusammengeführt: {r['dubletten']} (inkl. 12 im Post-Merge-Check über Ortsname/PLZ zusammengeführter – willhaben vs. dibeo/immobilien.net/derStandard). Über Aufnahme-Obergrenze verworfen: {r['verworfen']}.\n")
lines.append(kopf)
