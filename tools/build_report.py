...
kopf = (f"# Delta-Bericht Immobilien-Lauf\n\n"
        ...
        f"Suche: 6 Großregionen parallel (Sub-Agenten) + willhaben via Browser (Kärnten Häuser & Grundstücke, Aktualität). "
...
out = os.path.join(ROOT, "berichte", "delta_2026-07-06_1230.md")
