...
kopf = (f"# Delta-Bericht Immobilien-Lauf\n\n"
        ...
        f"Suche: 6 Großregionen parallel (Sub-Agenten: Kärnten+Osttirol, Salzburg, Steiermark, Tirol+Vorarlberg, OÖ+NÖ, Südtirol; 50 Kandidaten) + willhaben via Chrome-Browser (Kärnten + Steiermark, Häuser & Grundstücke, nach Aktualität; 33 Kandidaten). Volltreffer u.a.: Haus Metnitz/Kärnten 285k/300 m²/2.014 m², Haus Straden 179k/342 m²/4.072 m², Bauernhaus Hopfberg/Taxenbach 570k (Score 62), EFH Krakaudorf/Murau 545k/258 m² (55), Landhaus Fischertratten/Malta 455k/180 m² (60); Grundstücke St. Salvator 125k/2.191 m² (Bauland-Dorfgebiet), Krakau 146k/3.246 m² (60), Kreuth-Pischeldorf 100k/1.380 m², Rosental a.d. Kainach 65k/1.137 m². Häuser 650–900k und Grundstücke 150–200k werden als Near-Miss „TEIL – verfehlt: Preis\" geführt (Zielpreise 650k bzw. 150k). ⚠️ Südtirol-Baugrundstücke in diesem Lauf 0 (Ansässigkeit/Grünland); Tirol+Vorarlberg 0 Volltreffer (Grund <1.000); idealista/casa.it bot-blockiert, immomarkt-suedtirol.bz/pareggerpartner JS-gerendert. "
...
out = os.path.join(ROOT, "berichte", "delta_2026-07-14_0739.md")
