...
kopf = (f"# Delta-Bericht Immobilien-Lauf\n\n"
        ...
        f"Suche: 6 Großregionen parallel (Sub-Agenten: Kärnten+Osttirol, Salzburg, Steiermark, Tirol+Vorarlberg, OÖ+NÖ, Südtirol) + willhaben via Chrome-Browser (Kärnten + Steiermark, Häuser & Grundstücke, nach Aktualität; 20 Kandidaten, u.a. Volltreffer-Häuser Hochstraden/Vulkanland 420k/188 m² (Score 57), Stenzengreith/Weiz Waldrandlage 635k (57), Grottenhof/Leibnitz Aussicht 497k/2.670 m² (50) + Volltreffer-Grundstücke Gniebing b. Feldbach 88k/1.263 m² Aussicht, Gamlitz 139k/1.047 m², dazu Near-Miss Ratsch & Leutschach an der Weinstraße mit 1–1,3 ha, Score 70). Häuser 650–900k und Grundstücke 150–200k werden als Near-Miss „TEIL – verfehlt: Preis“ geführt (Zielpreise 650k bzw. 150k). ⚠️ Südtirol-Baugrundstücke in diesem Lauf 0 (Ansässigkeit/Grünland); idealista/casa.it bot-blockiert, immomarkt-suedtirol.bz/pareggerpartner JS-gerendert. "
