...
kopf = (f"# Delta-Bericht Immobilien-Lauf\n\n"
        ...
        f"Suche: 6 Großregionen parallel (Sub-Agenten: Kärnten+Osttirol, Salzburg, Steiermark, Tirol+Vorarlberg, OÖ+NÖ, Südtirol) + willhaben via Chrome-Browser (Kärnten + Steiermark, Häuser & Grundstücke, nach Aktualität; u.a. Volltreffer-Haus St. Georgen a.d. Stiefing 490k/2.983 m² + Volltreffer-Grundstück St. Andrä/Lavanttal Bauland-Dorfgebiet 60k/1.191 m² mit fantastischem Ausblick, dazu mehrere Near-Miss). Häuser 650–900k und Grundstücke 150–200k werden als Near-Miss „TEIL – verfehlt: Preis“ geführt (Zielpreise 650k bzw. 150k). ⚠️ Südtirol-Baugrundstücke in diesem Lauf 0 (Ansässigkeit/Grünland); idealista/casa.it bot-blockiert, immomarkt-suedtirol.bz/pareggerpartner JS-gerendert. "
