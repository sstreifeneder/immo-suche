...
CAND_DIR = sys.argv[1] if len(sys.argv) > 1 else "/sessions/sweet-bold-einstein/mnt/outputs"
NOW_ISO = "2026-07-14T07:39:00+02:00"
TODAY = "2026-07-14"
...
def main():
    ...
    hist = {
        ...
        "willhaben": "abgedeckt (Chrome, __NEXT_DATA__, Kärnten & Steiermark, Häuser & Grundstücke nach Aktualität; 20 Kandidaten, 11 Volltreffer). Volltreffer-Häuser: Feistritz a.d. Drau/Feffernitz (438k, 197 m², 1.770 m²) + Klagenfurt-Pitzelstätten (550k, 190 m², 1.700 m²) + Stenzengreith/Weiz Waldrandlage (635k, 164 m², 1.207 m², Score 57) + Hochstraden/Vulkanland absolute Ruhelage (420k, 188 m², Score 57) + Grottenhof/Leibnitz Aussichtslage (497k, 170 m², 2.670 m², Score 50) + Großklein Bungalow (597k) + Langenwang/Mürztal (275k, 245 m², 3.000 m²). Volltreffer-Grundstücke: Sittersdorf 79k/1.086, Ludmannsdorf 98k/1.410, Gamlitz 139k/1.047, Gniebing b. Feldbach 88k/1.263 (Aussicht). Near-Miss: Ratsch a.d. Weinstraße 697k/10.037 m² (Score 70) + Leutschach „Steirische Toskana\" 690k/13.109 m² (Score 70) + Pirka/Graz-Umgebung 749k; Grundstücke Velden-Karawankenblick 195k, St. Marein b. Graz 199k, Gossendorf/Feldbach 174k (Preis), Kitzeck im Sausal 115k (Widmung ungesichert), St. Peter am Kammersberg 150k (Ferien-Nutzung).",
        "sub_agenten": "6 Großregionen parallel (Kärnten+Osttirol 9, Salzburg 7, Steiermark 13, Tirol+Vorarlberg 1, OÖ+NÖ 6, Südtirol 9 Kandidaten). Volltreffer u.a.: Kärnten Landhaus Hüttenberg (495k, 180 m², 1.327 m²) + Baugrund Kötschach-Mauthen (110k, 1.090 m²); Steiermark Bauernhaus Gießelsdorf/St. Anna (245k), Landhaus Kirchberg a.d. Raab (495k), Anwesen Stainz (650k, 12.869 m², Score 85), Haus Krakaudorf/Murau (545k, Bergblick), Bungalow Großklein (597k) + Baugründe Neumarkt, Straden, Bad Gams, St. Margarethen b. Knittelfeld; OÖ+NÖ EFH Ramsau/Lilienfeld (490k, 280 m², 1.918 m², Score 72) + Bauernhaus Friedersbach/Waldviertel (349k, 196 m², Selbstversorger) + Baugründe Ernegg/Mostviertel + Weyer/Enns; Südtirol EFH St. Walburg/Ulten (280k, 160 m², 9.900 m²). Salzburg 0 Volltreffer (Innergebirge zu teuer bzw. Grund <1.000), Tirol+Vorarlberg 0 Volltreffer (Grund durchweg <1.000). Südtirol 0 Baugrundstücke (Grünland/Ansässigkeit); pareggerpartner.com/immoco.it JS-leer, idealista.it/casa.it bot-blockiert.",
