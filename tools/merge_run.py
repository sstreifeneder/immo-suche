...
def main():
    ...
    hist = {
        ...
        "willhaben": "abgedeckt (Chrome, __NEXT_DATA__, Kärnten & Steiermark, Häuser & Grundstücke nach Aktualität). Volltreffer-Häuser: Tauplitz/Ennstal (2.413 m², Grimmingblick, 425k, Score 54) + Obergöriach nahe Pörtschach (Fernblick, 1.721 m², 590k) + Seggauberg/Leibnitz (Neubau Grünruhelage, 550k) + Althofen (630k) + Preding-Bürgerhaus (370k). Volltreffer-Grundstücke: Deutsch Goritz/Südoststeiermark (Bauland Dorfgebiet, 2.739 m², Ganztagssonne, 36k, Score 59) + Krumegg, Feldbach, Nestelbach, Eggersdorf, Oberdorf a.H., Ebenthal, Maria Saal, Moosburg (Duel/Velden = Dublette Bestand). Near-Miss (Preis): Landhaus Rotschitzen 750k + Villa Wolfsberg/Schwarzautal 770k (Wohnrecht) + Grundstücke Ferndorf 159k, Gmünd 189k, Bad Gams 165k, Köttmannsdorf 184k, Tultschnig 199,5k. Waldbach/Joglland TEIL (Gesamtgrund ungesichert)",
        "sub_agenten": "6 Großregionen parallel (Kärnten+Osttirol 17, Salzburg 6, Steiermark 10, Tirol+Vorarlberg 9, OÖ+NÖ 12, Südtirol 7 Kandidaten). Südtirol nur eingeschränkt: idealista/casa.it bot-blockiert, immomarkt-suedtirol.bz/pareggerpartner JS-gerendert -> nur immoco/immoweb/engelvölkers verifizierbar",
